...
\title{Research Paper/ \\FloPy Workflows for Creating Structured and Unstructured MODFLOW Models} 
...
\begin{figure}[ht!]
	\begin{center}
		\includegraphics{figures/sv_voronoi_river_discretization.pdf}
	\end{center}
...
\begin{figure}[ht!]
	\begin{center}
		\includegraphics{figures/sv_voronoi_map.pdf}
	\end{center}
...
\begin{figure}[ht!]
	\begin{center}
		\includegraphics{figures/sv_voronoi_xsection.pdf}
	\end{center}
...
\begin{figure}[ht!]
	\begin{center}
		\includegraphics{figures/sv_voronoi_map_concentration.pdf}
	\end{center}
