...
\noindent The result of this code snippet is a list of Voronoi grid cell numbers (called ``cellids'') that intersect with the model grid.   Examples of the grid intersection capabilities for six different model grids with a linear stream network is shown in Figure \ref{fig:intersections}.
