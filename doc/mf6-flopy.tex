...
\begin{figure}[ht!]
	...
	\end{center}
	\caption{Cross-section of Synthetic Valley model grid and simulated steady-state heads along cross-section line (A) A--A' and (B) B--B'. The location of Blue Lake and pumping well P-2 are also shown on (A).}
	\label{fig:mvxsection}
\end{figure}

\subsection{Hydraulic and Transport Properties}

Hydraulic properties for the model were resampled from the data used in the structured grid model that was used as the starting point for \cite{hill1998} \citep{pollock2014percomm}. The horizontal hydraulic conductivity was discretized into five zones with values of 45.72, 50.29, 60.96, 83.82, and 121.92 meters/day; the lowest hydraulic conductivity zone was located south of Blue Lake and the highest hydraulic conductivity zone was located beneath Blue Lake. The vertical hydraulic conductivity in the upper and lower aquifer was specified to be one quarter of the horizontal hydraulic conductivity. The vertical and horizontal conductivity in the confining unit was set equal to 9.14$\times10^{-4}$ m/day. For the groundwater transport model the porosity was set to 0.2 in the upper and lower aquifer and 0.4 for cells in the confining unit.  For the transport model, the Total Variation Diminishing scheme was used to simulate advection and a  molecular dispersion coefficient of 0 m$^2$/day, longitudinal dispersivity of 75 meters, and transverse dispersivity of 7.5 meters was specified.
...
Straight River was discretized into 108 reaches. Cells that intersect the northern and southern end of Straight River are shown in Figures~\ref{fig:mvmap}\textit{B} and \textit{C}. The bed thickness and  width of each SFR reach was specified to be 0.3048 and 3.048 meters, respectively. The leakance for each SFR reach was calculated using the bed thickness, reach width, and reach length in each cell and based on a total Straight River conductance of 50,971.72 m$^2$/day. A specified rainfall rate of 0.0025 meters/day and a potential evaporation rate of  0.0019 meters/day was defined for each Straight River reach.

Blue Lake was simulated as a lake on top of the model grid and only had vertical connections to 1,406 cells in the underlying upper aquifer (model layer 1). A bed leakance of 0.0013 meters/day was specified for each cell connected to Blue Lake. A specified rainfall rate of 0.0025 meters/day and a potential evaporation rate of 0.0019 meters/day was defined Blue Lake.

Drain (DRN) cells were specified in each cell in model layer 1 that was not connected to Blue Lake to prevent water levels from exceeding the top of the model. The conductance of each DRN cell was based on the horizontal cell area, a thickness of 0.3048 meters, and a vertical hydraulic conductivity of 0.03048 meters/day. The drainage conductance was scaled from 0 to 100\% of the specified conductance from 1 meter below the top of the model to the top of the model, respectively.

Areal specified recharge and potential evapotranspiration rates of 0.0025 and 0.0019 meters/day were specified using the recharge (RCH) and evapotranspiration (EVT) packages. The EVT surface was specified to be the top of the model and the EVT extinction depth was specified to be 1 meter.

The location of pumping wells P1, P2, and P3 were determined using \texttt{GridIntersect().intersect()} FloPy functionality (Figure~\ref{fig:mvmap}\textit{A}). Pumping rates of -7,600, -7,600, and -1,900 m$^3$/day were specified for pumping wells P1, P2, and P3, respectively.
...
An initial head of 11 meters was specified for every cell. An initial stage of 3.44 meters was specified for Blue Lake. An initial concentration of 0 mg/L was specified for the transport model.
